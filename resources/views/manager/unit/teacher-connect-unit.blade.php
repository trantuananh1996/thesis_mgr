<div class="modal-content panel-primary">
    <div class="modal-header" style="background-color: #1ca59e; ">
        ...
        <h4 class="modal-title" id="myModalLabel" align="center" style="color: white;">DANH SÁCH CÁC GIÁO VIÊN THUỘC ĐƠN
            VỊ {{$unit->name}}</h4>
    </div>
    <div class="modal-content">
        ...
        <div class="table-responsive">
            <div class="col-md-5">
                <h4 align="center">Các giáo viên hiện có</h4>
            ...
            <div class="col-md-5">
                <h4 align="center">Các giáo viên chưa phân khoa</h4>
