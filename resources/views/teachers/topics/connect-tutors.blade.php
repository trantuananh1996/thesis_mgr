<div class="modal-content panel-primary">
    <div class="modal-header" style="background-color: #1ca59e; ">
        ...
        <h4 class="modal-title" id="myModalLabel" align="center" style="color: white;">PHÂN GIẢNG VIÊN THAM GIA KHÓA LUẬN</h4>
    </div>
		            ...
		            <tbody>
		                ...
		                <tr id="connect-row{{$connect_tutor->id}}" click="0" index="{{$connect_tutor->id}}">
		                    ...
		                    <td style="display: none">
		                        <input type="checkbox"  value="{{$connect_tutor->id}}" id="disconnect{{$connect_tutor->id}}">
		                    </td>
		                </tr>
		                @endforeach
		            </tbody>
		        ...
		        <table class="table table-striped table-bordered table-hover" id="tutors_disconnect_table">
		            ...
		            <tbody>
		                ...
		                <tr id="disconnect-row{{$disconnect_tutor->id}}" click="0" index="{{$disconnect_tutor->id}}">
		                    ...
		                    <td style="display: none">
		                        <input type="checkbox"  value="{{$disconnect_tutor->id}}" id="connect{{$disconnect_tutor->id}}">
		                    </td>
		                </tr>
		                @endforeach
		            </tbody>
