<div class="modal-content panel-primary">
    <div class="modal-header" style="background-color: #1ca59e; ">
        ...
        <h4 class="modal-title" id="myModalLabel" align="center" style="color: white;">SINH VIÊN ĐĂNG KÝ KHÓA LUẬN</h4>
    </div>
    <div class="modal-content">
        <br>
        <div class="prf-box">
            @if($topic->students_register->count()==0)
                <div align="center">Không còn sinh viên nào xin đăng kí khóa luận</div>
            @endif
